...
const TableCreate = () => {
  const { formValues, handleChange, storeTable, errors, setErrors } = useContext(TableContext);
  ...
  return (
    <div className='mt-12'>
      <form onSubmit={storeTable} className='max-w-md mx-auto p-4 bg-white shadow-md rounded-md'>
